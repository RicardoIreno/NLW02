...
function TeacherForm() {
  ...
  /* 
  '[field]' representa week_day. 
  Já existe uma variaável week_day dentro de schedulItem. 
  Como não podem haver duas variáveis com mesmo nome, 
  o valor de field vai sobrescrever o valor de week_day existente em
  scheduleItem. 
  */
  ...
  return (
    <div id="page-teacher-form" className="container">
      <PageHeader 
        title="Eu sou o teacher form"
        description="O primeiro passo é preencher esse fucking formulário">
